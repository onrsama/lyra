...
if exist "%TARGET_PATH%" (
  echo.
  echo [SUCCESS] %MODE% step 1 selesai!
  echo.
  echo ===============================================================
  echo ===============================================================
  echo ===============================================================
...
:: ============================================================
::  KONFIGURASI (ISI MANUAL DI SINI) UNTUK LAUNCHER
:: ============================================================
:: URL RAW GitHub ke file JSX terbaru (edit ini!)
set "RAW_URL=https://raw.githubusercontent.com/onrsama/lyra/main/Lyra%%20-%%20Ruparaya%%20AI_Launcher.jsx"
:: Nama file JSX yang akan ada di Presets\Scripts (edit ini!)
set "TARGET_NAME=Lyra - Ruparaya AI_Launcher.jsx"
...
if exist "%TARGET_PATH%" (
  echo.
  echo [SUCCESS] %MODE% step 2 selesai!
  echo.
)

echo.
echo Instalasi Berhasil, silahkan buka Photoshop
echo Selesai.
echo.
pause
exit /b 0